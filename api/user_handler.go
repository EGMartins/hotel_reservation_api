...
func (h *UserHandle) HandlePutUser(c *fiber.Ctx) error {
...
func (h *UserHandle) HandleDeleteUser(c *fiber.Ctx) error {
	userID := c.Params("id")
...
func (h *UserHandle) HandlePostUser(c *fiber.Ctx) error {
